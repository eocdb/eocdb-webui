...
import {
  ...
  OPEN_TERMS_DIALOG,
  CLOSE_TERMS_DIALOG,
  OPEN_TERMS_SINGLE_DIALOG,
  CLOSE_TERMS_SINGLE_DIALOG,
  OPEN_TERMS_DIRECT_DIALOG,
  CLOSE_TERMS_DIRECT_DIALOG,
...
export function dataTableReducer(
  ...
  switch (action.type) {
    ...
    case OPEN_TERMS_DIRECT_DIALOG: {
      return { ...state, termsDownloadDialogOpen: true };
    }
    case CLOSE_TERMS_DIRECT_DIALOG: {
      return { ...state, termsDownloadDialogOpen: false };
    }
    case UPDATE_DATASET: {
    ...
    case UPDATE_SELECTED_DATASETS: {
      return {
        ...state,
        selectedDatasets: action.selectedDatasets,
