...
export class LoginDialog2 extends React.Component<LoginDialogProps, LoginDialogState> {
    ...
    private handleNameOrEmailChange = (event: React.ChangeEvent<HTMLInputElement>) => {
        this.setState({nameOrEmail: this.state.nameOrEmail + event.currentTarget.value});
        console.log('handleNameOrEmailChange', this.state.nameOrEmail);
    };
